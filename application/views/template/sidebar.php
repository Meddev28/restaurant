                ...
                <ul class="pcoded-item pcoded-left-item">
                    <li class="pcoded-hasmenu">
                        <a href="javascript:void(0)">
                            ...
                            <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Manage</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class=" ">
                                <a href="<?php echo base_url(); ?>masterfile/position_list">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Employee Roles</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li class="">
                                <a href="<?php echo base_url(); ?>employees/overtime_list">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Bonus Hours</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li class="">
                                <a href="<?php echo base_url(); ?>employees/cashad_list">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Pay Advance</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li class="">
                                <a href="<?php echo base_url(); ?>employees/schedule_list">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Work Shifts</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                        </ul>
                ...
                <ul class="pcoded-item pcoded-left-item">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>masterfile/schedule_list">
                            ...
                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">Work Shifts</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li>
